...
export default function App() {
  ...
  const getCategories = async () =>{
    ...
    try{
      const res = await axios.get("https://671cc5b209103098807b2644.mockapi.io/gki/category");
  ...
  const getLocation = async () => {
    try{
      const res = await axios.get("https://671cc5b209103098807b2644.mockapi.io/gki/location");
